...
class RunnerConfig:
    ...
    def create_run_table_model(self) -> RunTableModel:
        ...
        adapt_rounds = StrategyModel("rounds", [1, 3, 5, 10, 20])
        self.run_table_model = RunTableModel(
            strategies=[adapt_rounds],
            exclude_variations=[],
            data_columns=['run', 'strategy', 'iterations', 'output']
        )
    ...
    def interact(self, context: RunnerContext) -> None:
        ...
        rounds = context.run_variation['rounds']
        ...
        context.run_variation['strategy'] = context.run_variation['rounds']
        context.run_variation['iterations'] = rounds
